...
export function remainingMinutesInOven(actualMinutesInOven) {
  let tempoRestante = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
...
export function preparationTimeInMinutes(numberOfLayers) {
  let tempoDePreparo = numberOfLayers* PREPARATION_MINUTES_PER_LAYER;
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  let tempoDePreparo = preparationTimeInMinutes(numberOfLayers);
  return tempoDePreparo + actualMinutesInOven;
}